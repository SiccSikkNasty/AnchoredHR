...
if (!captcha) {
  ...
  fetch("https://script.google.com/macros/s/AKfycbxuz7634TUr8IxvnNR2o9DFOzBtgwJdgxARZtPCRRavrStg7--gr8mrMZt8pshVanMg/exec", {
    method: "POST",
    body: formData
  })
  ...
  .then(text => {
    ...
    if (data.result === "success") {
      ...
      `;
      setTimeout(() => {
        window.location.href = "https://anchoredhr.ca";
      }, 3000);
    } else {
